...
{{-- Extending Main Content Section --}}
@yield('main')
    ...
    $('#updateImageForm').on('submit', function(e){
        ...
        $.ajax({
            ...
            success : function(response) {
                ...
                if (response.status) {
                    $('#image').removeClass('is-invalid').siblings('small').removeClass('invalid-feedback').text("");
                    window.location.href = '{{ url()->current() }}';
                } else {
                    if (response.errors.image) {
                        $('#image').addClass('is-invalid').siblings('small').addClass('invalid-feedback').text(response.errors.image);
                    }
                }
