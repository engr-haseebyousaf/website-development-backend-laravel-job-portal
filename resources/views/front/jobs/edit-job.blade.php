                        ...
                        <div class="card border-0 shadow mb-4 ">
                            <div class="card-body card-form p-4">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-4">
                                            ...
                                            <input type="number" value="{{ $job->experiance }}" placeholder="experiance" id="experiance" name="experiance"
                                                class="form-control">
                                                <small></small>
                                        </div>
                                    </div>
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="text" value="{{ $job->company_website }}" placeholder="Company Website" id="company_website" name="company_website"
                                        class="form-control">
                                        <small></small>
                                </div>
                            </div>
...
@section('extra_js')
    <script>
        $('#editJobForm').submit(function(e) {
            ...
            // return false;
            $.ajax({
                url: "{{ route('job.update', ['id' => $job->id]) }}",
                type: "put",
